...
const template: AnswerCardTemplate = {
  id: 'test', name: '测试答题卡', subject: '数学', questionCount: 3,
  answers: ['A', 'B', 'C'], createdAt: '2025-01-01T00:00:00.000Z',
}

describe('真实答案批改', () => {
  it('按识别到的真实选项逐题判分', () => {
    const record = gradeAnswers(template, '张同学', 'paper.jpg', ['A', 'D', 'C'], [1, .9, 1])
